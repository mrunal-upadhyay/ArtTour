...
public class ArtDetailFragment extends BaseFragment implements EasyPermissions.PermissionCallbacks {
  ...
  public static ArtDetailFragment newInstance(@NonNull Artwork artwork) {
