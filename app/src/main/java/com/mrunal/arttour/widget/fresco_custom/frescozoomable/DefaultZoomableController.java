...
package com.mrunal.arttour.widget.fresco_custom.frescozoomable;
...
import com.mrunal.arttour.widget.fresco_custom.frescozoomable.gestures.TransformGestureDetector;
...
public class DefaultZoomableController
   ...
   *
   * We should rename this method to `wasTransformedWithoutCorrection` and just return the internal
   * flag directly. However, this requires interface change and negation of meaning.
   */
  @Override
