...
public class FrescoCircularProgressDrawable extends CircularProgressDrawable {
   ...
   */
  public FrescoCircularProgressDrawable(int ringWidth, float circleScale, int outlineColor,
      int ringColor, int centerColor, int size) {
  ...
  public static class Builder {
    ...
    public FrescoCircularProgressDrawable create() {
      return new FrescoCircularProgressDrawable(ringWidth, circleScale, outlineColor, ringColor,
          centerColor, size);
    }
