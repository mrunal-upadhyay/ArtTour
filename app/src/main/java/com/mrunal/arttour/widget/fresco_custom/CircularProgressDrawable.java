package com.mrunal.arttour.widget.fresco_custom;
 ...
 * <p/>
 * This drawable will produce a circular shape with a ring surrounding it. The ring can appear both
 * filled and give a little cue when it is empty.
 * <p/>
...
public class CircularProgressDrawable extends Drawable {
   ...
   * <p/>
   * The inner ring is supposed to defaults stay 3/4 radius off the outer ring at (75% scale), but
   * this property can make it grow or shrink via this equation: OuterRadius * Scale.
   * <p/>
   ...
   * <p/>
   * The progress of the circle. If {@link #setIndeterminate(boolean) indeterminate flag} is set to
   * FALSE, this property will be used to indicate the completion of the outer circle [0..1f].
   * <p/>
   * If set to TRUE, the drawable will activate the loading mode, where the drawable will show a 90º
   * arc which will be spinning around the outer circle as much as progress goes.
   */
  ...
  /**
   * Scale of the inner circle. It will affect the inner circle size on this equation: ([Biggest
   * length of the Drawable] / 2) - (ringWidth / 2) * scale.
   */
   ...
   * <p/>
   * The indeterminate parameter will change the behavior of the Drawable. If the indeterminate mode
   * is set to FALSE, the outer ring will be able to be filled by using {@link #setProgress(float)
   * setProgress}.
   * <p/>
   * Otherwise the drawable will enter "loading mode" and a 90º arc will be able to be spinned
