package com.mrunal.arttour.model;
...
public class Artwork implements Parcelable {
  ...
  public Artwork(Links links, String id, String objectNumber, String title, boolean hasImage,
      String principalOrFirstMaker, String longTitle, boolean showImage, boolean permitDownload,
      WebImage webImage, HeaderImage headerImage) {
    this.links = links;
    this.id = id;
  ...
  public float getAspectRatio() {
    return (float) (Math.floor(((double) webImage.getWidth() / webImage.getHeight()) * 1000 + .5)
        / 1000);
  }
  ...
  public static class WebImage implements Parcelable {
    ...
    public WebImage(String guid, long offsetPercentageX, long offsetPercentageY, long width,
        long height, String url) {
      this.guid = guid;
  ...
  public static class HeaderImage implements Parcelable {
    ...
    public HeaderImage(String guid, long offsetPercentageX, long offsetPercentageY, long width,
        long height, String url) {
      this.guid = guid;
      this.offsetPercentageX = offsetPercentageX;
      this.offsetPercentageY = offsetPercentageY;
